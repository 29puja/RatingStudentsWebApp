<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <body>
        ...
        <div class="signup-form">
            <form id="cov" action="sv2.jsp" method="post" onsubmit="return myFunction()" />
            <!--<h5 style="text-align: center; margin-bottom: 1rem;font-size: 30px;"><span class="footer-logo">PORTAL</span> FOR DOCTORS</h5>-->
            <h2 style="text-align: center;">Remove Assignment category</h2>
            <p style="text-align: center;">Please fill in this form for Remove Assignment Category!</p>
            <hr>
		...
		con.close();  
		 ...
		 System.out.println(e);
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col"> <b><p>Srno:-</p><b><input type="number" class="form-control" id="po" name="po" placeholder="Srno of assignment category you want to remove" required></div>
