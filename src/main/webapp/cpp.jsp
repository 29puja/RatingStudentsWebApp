...
<html ><head>
  ...
  <link rel="stylesheet" type="text/css" href="css/signup.css"> 
    ...
    <div class="signup-form">
        <form id="cov" action="sv6.jsp" method="post" onsubmit="return myFunction()" />
            <!--<h5 style="text-align: center; margin-bottom: 1rem;font-size: 30px;"><span class="footer-logo">PORTAL</span> FOR DOCTORS</h5>-->
            <h2 style="text-align: center;">Compute & Display subject average score per assignment category &overall rating for assigned student</h2>
            <p  style="text-align: center;">Please fill in this form for Calculate!</p>
            <hr>
            
			<div class="form-group">
                <div class="row"> 
                    <div class="col"> <b><p>Subject Name:-</p><b><input type="text" class="form-control" id="fname" name="fname" placeholder="Enter Subject Name" required></div>
