        ...
        <form id="cov" action="" method="POST" enctype="multipart/form-data" onsubmit="return myFunction()" />
            ...
            <div class="form-group">
                <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="sc" name="sc">
                 ...
                 <option value="1">Add Assignment Category</option>
                 <option value="2">Remove Assignment Category</option>
                 <option value="3">Display Assignment Category</option>
...
function myFunction() {
  ...
  {
	  document.getElementById("cov").action = "addDistri.jsp";
  }
  else if(inpObj=="2")
  {
	  document.getElementById("cov").action = "remDistri.jsp";
  }
  else if(inpObj=="3")
  {
	  document.getElementById("cov").action = "disDistri.jsp";
  }
