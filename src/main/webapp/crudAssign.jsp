        ...
        <form id="cov" action="" method="POST" enctype="multipart/form-data" onsubmit="return myFunction()" />
            ...
            <div class="form-group">
                <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="sc" name="sc">
                 ...
                 <option value="1">Enroll Student in Subject</option>
                 <option value="2">Remove Student</option>
                 <option value="3">Display Assignments</option>
...
function myFunction() {
  ...
  {
	  document.getElementById("cov").action = "enroll.jsp";
  }
  else if(inpObj=="2")
  {
	  document.getElementById("cov").action = "remstu.jsp";
  }
  else if(inpObj=="3")
  {
	  document.getElementById("cov").action = "disass.jsp";
  }
